  ...
  const products = [
    {
      ...
      variants: [
        { size: 'S', color: 'Black', colorHex: '#1a1a1a', sku: 'MR-ACIDTEE-BLK-S', price: 74900, stock: 6 },
        { size: 'M', color: 'Black', colorHex: '#1a1a1a', sku: 'MR-ACIDTEE-BLK-M', price: 74900, stock: 0 },
        { size: 'L', color: 'Black', colorHex: '#1a1a1a', sku: 'MR-ACIDTEE-BLK-L', price: 74900, stock: 0 },
        { size: 'XL', color: 'Black', colorHex: '#1a1a1a', sku: 'MR-ACIDTEE-BLK-XL', price: 74900, stock: 4 },
        { size: 'XXL', color: 'Black', colorHex: '#1a1a1a', sku: 'MR-ACIDTEE-BLK-XXL', price: 74900, stock: 2 },
      ],
    },
    {
      ...
      variants: [
        { size: 'S', color: 'Beige', colorHex: '#a3865f', sku: 'MR-ACIDTEE-BEI-S', price: 74900, stock: 4 },
        { size: 'M', color: 'Beige', colorHex: '#a3865f', sku: 'MR-ACIDTEE-BEI-M', price: 74900, stock: 0 },
        { size: 'L', color: 'Beige', colorHex: '#a3865f', sku: 'MR-ACIDTEE-BEI-L', price: 74900, stock: 3 },
        { size: 'XL', color: 'Beige', colorHex: '#a3865f', sku: 'MR-ACIDTEE-BEI-XL', price: 74900, stock: 3 },
        { size: 'XXL', color: 'Beige', colorHex: '#a3865f', sku: 'MR-ACIDTEE-BEI-XXL', price: 74900, stock: 1 },
      ],
    },
    {
      ...
      variants: [
        { size: 'S', color: 'Olive', colorHex: '#5b6350', sku: 'MR-ACIDTEE-OLV-S', price: 74900, stock: 3 },
        { size: 'M', color: 'Olive', colorHex: '#5b6350', sku: 'MR-ACIDTEE-OLV-M', price: 74900, stock: 0 },
        { size: 'L', color: 'Olive', colorHex: '#5b6350', sku: 'MR-ACIDTEE-OLV-L', price: 74900, stock: 4 },
        { size: 'XL', color: 'Olive', colorHex: '#5b6350', sku: 'MR-ACIDTEE-OLV-XL', price: 74900, stock: 3 },
        { size: 'XXL', color: 'Olive', colorHex: '#5b6350', sku: 'MR-ACIDTEE-OLV-XXL', price: 74900, stock: 0 },
      ],
    },
  ];
