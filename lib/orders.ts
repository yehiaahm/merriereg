  ...
  return prisma.$transaction(async (tx) => {
    ...
    const order = await tx.order.create({
      data: {
        ...
        // The City field was dropped from Checkout — derive it from the
        // chosen Delivery Area instead of asking for it twice.
        shippingCity: input.shippingGovernorate,
        shippingArea: input.shippingArea || null,
        shippingStreet: input.shippingStreet || null,
        shippingBuilding: input.shippingBuilding || null,
